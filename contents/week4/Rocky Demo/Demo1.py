...
In this demo we will work with a 3D motion capture file. This file contains XYZ 
motion capture data from 1 marker that was saved as 7 different markers. A new
marker was generated in the data file everytime the true marker left the visual
field and re-entered, therefore here are gaps in motion capture data.
...
mathmatical manipulations that can be done with position data.
"""
